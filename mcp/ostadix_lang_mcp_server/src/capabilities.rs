...
Use o_cli for expert project/route/retained-evidence options, compiler controls, packaging, hosted-session administration, Worlds, signed records, O-core, boot media and absorbed systems. o_eval and legacy tools remain compatible.
