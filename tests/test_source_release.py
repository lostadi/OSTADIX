...
pub const RUNTIME_HOSTED_REMOTE_FABRIC_SOURCES: &[(&str, &str)] = &[
    ...
    ("client.rs", include_str!("../hosted_remote/fabric/client.rs")),
    ("coordinator.rs", include_str!("../hosted_remote/fabric/coordinator.rs")),
    ("keys.rs", include_str!("../hosted_remote/fabric/keys.rs")),
    ("ledger.rs", include_str!("../hosted_remote/fabric/ledger.rs")),
    ("profile.rs", include_str!("../hosted_remote/fabric/profile.rs")),
...
class WorkspaceFacadeReleaseValidationTests(unittest.TestCase):
    ...
    def fixture_files() -> dict[str, bytes]:
        ...
        files.update({
            ...
            "src/cli_diagnostics.rs": b"// CLI fixture\n",
            "src/cli_paths.rs": b"// CLI fixture\n",
    ...
    def test_live_workspace_engine_is_structurally_closed(self) -> None:
        files = {
            ...
            for path in {
                ...
                "NOTICE",
                "src/lib.rs",
                *release.CLI_MODULE_PATHS.values(),
...
class SourceReleaseTests(unittest.TestCase):
    ...
    def _commit(self, files: dict[str, str | bytes] | None = None) -> str:
        contents = {
            ...
            "examples/manifest.json": json.dumps(
                {
                    ...
                    "examples": [
                        ...
                        },
                        {
                            ...
                            "expected": {
                                "rust": {"patterns": ["fixture-wasm"]}
                            },
                        },
                        {
                            "path": "webassembly_hello.O",
                            "editions": ["rust"],
                            "classification": "integration",
                            "requirements": {
                                "backends": ["webassembly"],
                                "programs": ["wasm-tools", "wasmtime"],
                                "authorities": ["process"],
                            },
                            "expected": {
                                "rust": {"patterns": ["fixture-webassembly"]}
                            },
                        },
                    ],
                },
            ...
            "mcp/ostadix_lang_mcp_server/src/installation.rs": "// MCP helper fixture\n",
            "mcp/ostadix_lang_mcp_server/src/tool_schema.rs": "// MCP helper fixture\n",
            ...
            "scripts/ostadix-hosted-live-desktop.sh": "#!/bin/sh\n",
            "scripts/ostadix_boot_objects.py": "#!/usr/bin/env python3\n",
            ...
            "scripts/ostadix_wasm_release.py": "#!/usr/bin/env python3\n",
            ...
            "crates/ostadix-api/src/hosted_remote/fabric/client.rs": "// fixture Fabric client\n",
            "crates/ostadix-api/src/hosted_remote/fabric/coordinator.rs": "// fixture Fabric coordinator adapter\n",
            "crates/ostadix-api/src/hosted_remote/fabric/coordinator_tests.rs": "// fixture Fabric coordinator tests\n",
            ...
            "crates/ostadix-api/src/hosted_remote/fabric/profile.rs": "// fixture Fabric renderer profile\n",
            ...
            "src/main.rs": "fn main() {}\n",
            "scripts/install_native_binaries.py": "// release surface fixture\n",
            "scripts/check_language_sources.py": "// release surface fixture\n",
            "scripts/render_docs.py": "// release surface fixture\n",
            "ci/language-sources.json": "// release surface fixture\n",
            "docs/html-exports.json": "// release surface fixture\n",
            "tests/test_native_install.py": "// release surface fixture\n",
            "tests/test_language_sources.py": "// release surface fixture\n",
            "tests/test_render_docs.py": "// release surface fixture\n",
            ...
            "c_cpp/tests/test_installed_paths.py": "# C installed path tests fixture\n",
            ...
            "tests/test_hosted_live_workstation_payload.py": (
                "# fixture hosted-live workstation payload tests\n"
            ),
            "tests/test_ostadix_boot_objects.py": "# fixture boot-object builder tests\n",
            "tests/test_ostadix_hosted_live_all_smoke.py": (
                "# fixture complete hosted-live smoke tests\n"
            ),
            "tests/test_ostadix_hosted_live_boot_objects.py": (
                "# fixture hosted-live boot-object integration tests\n"
            ),
            "tests/test_ostadix_hosted_live_ocore_smoke.py": (
                "# fixture hosted-live O-core smoke tests\n"
            ),
            "tests/test_ostadix_hosted_live_release.py": (
                "# fixture hosted-live release tests\n"
            ),
            "tests/test_ostadix_hosted_live_vga_smoke.py": (
                "# fixture hosted-live VGA smoke tests\n"
            ),
    ...
    def test_allowlist_includes_sources_and_excludes_release_debris(self) -> None:
        ...
        with zipfile.ZipFile(result.output) as archive:
            ...
            included = {
                ...
                "crates/ostadix-api/src/hosted_remote/fabric/mod.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/client.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/coordinator.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/coordinator_tests.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/keys.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/ledger.rs",
                "crates/ostadix-api/src/hosted_remote/fabric/profile.rs",
                ...
                "tests/test_hosted_live_workstation_payload.py",
                "tests/test_ostadix_boot_objects.py",
                "tests/test_ostadix_hosted_live_all_smoke.py",
                "tests/test_ostadix_hosted_live_boot_objects.py",
                "tests/test_ostadix_hosted_live_ocore_smoke.py",
                "tests/test_ostadix_hosted_live_release.py",
    ...
    def test_fresh_attestation_cannot_couple_replace_the_trusted_validator(self) -> None:
        path = "evidence/world/g0-attribution-history-continuity-2026-09-17.toml"
