...
- `/data/data/com.termux/files/home/Ostadix-lang/phoneoptimize-codex-session-01a0a549-0d55-7453-82b4-e2ab2da953f3.md`
...
The read-only/build investigation workspace remains at
`/data/local/tmp/codex-litert-route-20260915` (about 1.5 GiB, no model). It retains LiteRT-LM 0.17,
the Android wheel, the pinned LiteRT source, comparison runtime archives, and failed build evidence.
