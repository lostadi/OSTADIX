...
OSTADIX_API_ROOT_MODULE_PATHS = {
    ...
    "cancellation": f"{OSTADIX_API_SOURCE_ROOT}/cancellation.rs",
    ...
    "execution_fabric": f"{OSTADIX_API_SOURCE_ROOT}/execution_fabric/mod.rs",
    "execution_fabric_authority": f"{OSTADIX_API_SOURCE_ROOT}/execution_fabric_authority/mod.rs",
    ...
    "intent": f"{OSTADIX_API_SOURCE_ROOT}/intent/mod.rs",
...
WORLD_CURRENT_VALIDATOR_SHA256 = (
    "d46500586e37e162c84ab9b99e5bf7254b496bf70c027f22bf74b97f573edac0"
)
